        ...
        <div class="row">
            <div class="article-text col-md-8">
                ...
                <p class="mt-4">
                    ...
                    <nuxt-link class="d-block" v-for="contrib in contributors" :key="contrib.URLName" :to="'/medarbetare/' + contrib.URLName" rel="author">{{contrib.FirstName}} {{contrib.LastName}}</nuxt-link>
                </p>
